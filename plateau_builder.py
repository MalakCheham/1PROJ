...
def lancer_plateau_builder(type_jeu, mode_ia=False):
    root = tk.Tk()
    ...
    btn = tk.Button(root, text="Lancer la Partie", command=lancer_partie, bg="green", fg="white", font=("Helvetica", 12, "bold"))
    btn.pack(pady=15)
